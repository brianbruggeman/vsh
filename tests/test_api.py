...
def test_enter(tmpdir, capsys, command, expected_output):
    from ves.api import create, enter
...
def test_remove(tmpdir, name, error_name, check):
    from ves.api import create, remove
    from ves import errors
...
def test_show_envs(tmpdir, capsys):
    from ves.api import create, remove, show_envs
...
def test_show_version(tmpdir, capsys):
    from ves.api import show_version
    from ves.__metadata__ import package_metadata
