...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('keywords', ('vsh', 'virtual environment', 'venv')),
...
def test_metadata_version():
    ...
    p = PackageMetadata()
    version_fields = ['version', 'major', 'minor', 'micro', 'release']
...
@pytest.mark.parametrize('exc_name, message', [('BaseError', None), ('BaseError', 'Test message')])
