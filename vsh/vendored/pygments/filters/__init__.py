...
from vsh.vendored.pygments.token import String, Comment, Keyword, Name, Error, Whitespace, \
    string_to_tokentype
from vsh.vendored.pygments.filter import Filter
from vsh.vendored.pygments.util import get_list_opt, get_int_opt, get_bool_opt, \
     get_choice_opt, ClassNotFound, OptionError, text_type, string_types
from vsh.vendored.pygments.plugin import find_plugin_filters
