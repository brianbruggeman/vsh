...
from vsh.vendored.pygments.formatter import Formatter
from vsh.vendored.pygments.lexer import Lexer
from vsh.vendored.pygments.token import Token, STANDARD_TYPES
from vsh.vendored.pygments.util import get_bool_opt, get_int_opt, StringIO, xrange, \
    iteritems
