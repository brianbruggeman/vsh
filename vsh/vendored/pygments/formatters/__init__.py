...
from vsh.vendored.pygments.formatters._mapping import FORMATTERS
from vsh.vendored.pygments.plugin import find_plugin_formatters
from vsh.vendored.pygments.util import ClassNotFound, itervalues
