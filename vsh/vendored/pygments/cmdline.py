...
from vsh.vendored.pygments import __version__, highlight
from vsh.vendored.pygments.util import ClassNotFound, OptionError, docstring_headline, \
    guess_decode, guess_decode_from_terminal, terminal_encoding
from vsh.vendored.pygments.lexers import get_all_lexers, get_lexer_by_name, guess_lexer, \
    load_lexer_from_file, get_lexer_for_filename, find_lexer_class_for_filename
from vsh.vendored.pygments.lexers.special import TextLexer
from vsh.vendored.pygments.formatters.latex import LatexEmbeddedLexer, LatexFormatter
from vsh.vendored.pygments.formatters import get_all_formatters, get_formatter_by_name, \
    load_formatter_from_file, get_formatter_for_filename, find_formatter_class
from vsh.vendored.pygments.formatters.terminal import TerminalFormatter
from vsh.vendored.pygments.formatters.terminal256 import Terminal256Formatter
from vsh.vendored.pygments.filters import get_all_filters, find_filter_class
from vsh.vendored.pygments.styles import get_all_styles, get_style_by_name
...
def main_inner(popts, args, usage):
    ...
    if not outfn and sys.platform in ('win32', 'cygwin') and \
       fmter.name in ('Terminal', 'Terminal256'):  # pragma: no cover
        ...
        if sys.version_info > (3,):
            from vsh.vendored.pygments.util import UnclosingTextIOWrapper
