...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups, using, this, words, \
    inherit, default
from vsh.vendored.pygments.token import Text, Keyword, Name, String, Operator, \
...
def objective(baselexer):
    ...
    class GeneratedObjectiveCVariant(baselexer):
        ...
        def get_tokens_unprocessed(self, text):
            from vsh.vendored.pygments.lexers._cocoa_builtins import COCOA_INTERFACES, \
