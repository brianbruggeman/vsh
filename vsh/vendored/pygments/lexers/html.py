...
from vsh.vendored.pygments.lexer import RegexLexer, ExtendedRegexLexer, include, bygroups, \
    default, using
from vsh.vendored.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Punctuation
from vsh.vendored.pygments.util import looks_like_xml, html_doctype_matches

from vsh.vendored.pygments.lexers.javascript import JavascriptLexer
from vsh.vendored.pygments.lexers.jvm import ScalaLexer
from vsh.vendored.pygments.lexers.css import CssLexer, _indentation, _starts_block
