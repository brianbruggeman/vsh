...
from vsh.vendored.pygments.lexer import RegexLexer, words, include, bygroups, using, \
    this, default
from vsh.vendored.pygments.token import Text, Comment, Operator, Keyword, Name, \
...
class AsymptoteLexer(RegexLexer):
    ...
    def get_tokens_unprocessed(self, text):
        from vsh.vendored.pygments.lexers._asy_builtins import ASYFUNCNAME, ASYVARNAME
