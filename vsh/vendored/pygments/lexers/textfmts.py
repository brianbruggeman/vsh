...
from vsh.vendored.pygments.lexer import RegexLexer, bygroups
from vsh.vendored.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Generic, Literal
from vsh.vendored.pygments.util import ClassNotFound
...
class HttpLexer(RegexLexer):
    ...
    def content_callback(self, match):
        ...
        offset = match.start()
        if content_type:
            from vsh.vendored.pygments.lexers import get_lexer_for_mimetype
