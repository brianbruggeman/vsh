...
from vsh.vendored.pygments.lexer import RegexLexer, bygroups, include, this, using, words
from vsh.vendored.pygments.token import Comment, Keyword, Literal, Name, Number, \
