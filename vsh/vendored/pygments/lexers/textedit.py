...
from vsh.vendored.pygments.lexer import RegexLexer, include, default, bygroups, using, this
...
class VimLexer(RegexLexer):
    ...
    def __init__(self, **options):
        from vsh.vendored.pygments.lexers._vim_builtins import command, option, auto
        self._cmd = command
        self._opt = option
        self._aut = auto
