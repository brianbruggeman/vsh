...
from vsh.vendored.pygments.lexer import ExtendedRegexLexer, LexerContext, \
    bygroups, words, include, default
from vsh.vendored.pygments.token import Comment, Keyword, Literal, Name, Number, Operator, \
