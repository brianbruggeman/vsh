...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups, default, combined, \
    words
...
from vsh.vendored.pygments.util import get_bool_opt, get_list_opt, iteritems
...
class LuaLexer(RegexLexer):
    ...
    `disabled_modules`
        ...
        .. sourcecode:: pycon
            ...
            >>> from vsh.vendored.pygments.lexers._lua_builtins import MODULES
            >>> MODULES.keys()
