...
from vsh.vendored.pygments.lexer import RegexLexer, bygroups, default, include, using, words
from vsh.vendored.pygments.token import Comment, Keyword, Name, Number, Operator, Punctuation, \
    String, Text
from vsh.vendored.pygments.lexers._csound_builtins import OPCODES
from vsh.vendored.pygments.lexers.html import HtmlLexer
from vsh.vendored.pygments.lexers.python import PythonLexer
from vsh.vendored.pygments.lexers.scripting import LuaLexer
