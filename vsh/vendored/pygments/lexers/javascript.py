...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups, default, using, \
    this, words, combined
from vsh.vendored.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Other
from vsh.vendored.pygments.util import get_bool_opt, iteritems
import vsh.vendored.pygments.unistring as uni
...
class LassoLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.builtinshighlighting:
            from vsh.vendored.pygments.lexers._lasso_builtins import BUILTINS, MEMBERS
