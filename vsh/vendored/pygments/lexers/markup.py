...
from vsh.vendored.pygments.lexer import RegexLexer, DelegatingLexer, include, bygroups, \
...
from vsh.vendored.pygments.util import get_bool_opt, ClassNotFound
...
class RstLexer(RegexLexer):
    ...
    def _handle_sourcecode(self, match):
        from vsh.vendored.pygments.lexers import get_lexer_by_name
