...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups, default
from vsh.vendored.pygments.token import Punctuation, Text, Comment, Operator, Keyword, \
    Name, String, Number
