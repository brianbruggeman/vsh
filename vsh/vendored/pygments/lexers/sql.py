...
from vsh.vendored.pygments.lexer import Lexer, RegexLexer, do_insertions, bygroups, words
from vsh.vendored.pygments.token import Punctuation, Whitespace, Error, \
    Text, Comment, Operator, Keyword, Name, String, Number, Generic
from vsh.vendored.pygments.lexers import get_lexer_by_name, ClassNotFound
from vsh.vendored.pygments.util import iteritems

from vsh.vendored.pygments.lexers._postgres_builtins import KEYWORDS, DATATYPES, \
    PSEUDO_TYPES, PLPGSQL_KEYWORDS
from vsh.vendored.pygments.lexers import _tsql_builtins
