...
from vsh.vendored.pygments.lexer import RegexLexer, include, words
from vsh.vendored.pygments.token import Comment, Keyword, Name, Number, \
    String, Text, Operator

from vsh.vendored.pygments.lexers._stata_builtins import builtins_base, builtins_functions
