...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups, using, words, \
    DelegatingLexer
from vsh.vendored.pygments.lexers.c_cpp import CppLexer, CLexer
from vsh.vendored.pygments.lexers.d import DLexer
from vsh.vendored.pygments.token import Text, Name, Number, String, Comment, Punctuation, \
