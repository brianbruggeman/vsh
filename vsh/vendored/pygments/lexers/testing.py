...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups
from vsh.vendored.pygments.token import Comment, Keyword, Name, String, Number, Generic, Text
