...
from vsh.vendored.pygments.lexer import RegexLexer, ExtendedRegexLexer, include, default, \
    words
from vsh.vendored.pygments.token import Name, Comment, String, Error, Number, Text, \
    Keyword, Punctuation
