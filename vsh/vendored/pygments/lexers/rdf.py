...
from vsh.vendored.pygments.lexer import RegexLexer, bygroups, default
from vsh.vendored.pygments.token import Keyword, Punctuation, String, Number, Operator, Generic, \
