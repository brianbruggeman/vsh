...
from vsh.vendored.pygments.lexer import RegexLexer, bygroups, include, combined, default, \
    words
from vsh.vendored.pygments.token import Text, Comment, Operator, Keyword, Punctuation, \
    Name, String, Number
