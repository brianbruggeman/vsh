...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups, using, this
from vsh.vendored.pygments.token import Keyword, Punctuation, Comment, Operator, Name,\
