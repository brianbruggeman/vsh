...
from vsh.vendored.pygments.lexer import RegexLexer, include, bygroups, words, default
...
class CommonLispLexer(RegexLexer):
    ...
    def __init__(self, **options):
        from vsh.vendored.pygments.lexers._cl_builtins import BUILTIN_FUNCTIONS, \
