...
from vsh.vendored.pygments.lexer import RegexLexer, words, include
from vsh.vendored.pygments.token import Comment, Keyword, Name, Number, Punctuation, String, Text
