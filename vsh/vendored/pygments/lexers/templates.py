...
from vsh.vendored.pygments.lexers.html import HtmlLexer, XmlLexer
from vsh.vendored.pygments.lexers.javascript import JavascriptLexer, LassoLexer
from vsh.vendored.pygments.lexers.css import CssLexer
from vsh.vendored.pygments.lexers.php import PhpLexer
from vsh.vendored.pygments.lexers.python import PythonLexer
from vsh.vendored.pygments.lexers.perl import PerlLexer
from vsh.vendored.pygments.lexers.jvm import JavaLexer, TeaLangLexer
from vsh.vendored.pygments.lexers.data import YamlLexer
from vsh.vendored.pygments.lexer import Lexer, DelegatingLexer, RegexLexer, bygroups, \
    include, using, this, default, combined
from vsh.vendored.pygments.token import Error, Punctuation, Whitespace, \
    Text, Comment, Operator, Keyword, Name, String, Number, Other, Token
from vsh.vendored.pygments.util import html_doctype_matches, looks_like_xml
...
class ErbLexer(Lexer):
    ...
    def __init__(self, **options):
        from vsh.vendored.pygments.lexers.ruby import RubyLexer
