...
from vsh.vendored.pygments.lexer import RegexLexer, ExtendedRegexLexer, LexerContext, \
    include, bygroups, inherit
from vsh.vendored.pygments.token import Text, Comment, Keyword, Name, String, Number, \
