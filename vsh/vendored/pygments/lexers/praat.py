...
from vsh.vendored.pygments.lexer import RegexLexer, words, bygroups, include
from vsh.vendored.pygments.token import Name, Text, Comment, Keyword, String, Punctuation, Number, \
    Operator
