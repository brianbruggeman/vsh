...
from vsh.vendored.pygments.lexer import RegexLexer
from vsh.vendored.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Error
from vsh.vendored.pygments.util import get_bool_opt
...
class SourcePawnLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.smhighlighting:
            from vsh.vendored.pygments.lexers._sourcemod_builtins import FUNCTIONS
